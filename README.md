...
|5|[Multi-label prediction](https://github.com/ruchikaverma-iitg/Hands-on-Deep-Learning/blob/master/Multi-label%20prediction.ipynbb)|Multi-label prediction using Resnet-50 model on Planet Amazon dataset obrtained from [Kaggle](https://www.kaggle.com/c/planet-understanding-the-amazon-from-space).|
